...
public class CurrencyControllerTest {
    ...
    private static List<CurrencyCreDto> createListOfCcy() {
        return List.of(
                CurrencyCreDto.builder().id(69).code("840").currency("USD").nameRussian("Доллар США").nameUzbek("AQSH dollari").nameUzbekKrill("АҚШ доллари").nameEnglish("US Dollar").nominal("1").rate(BigDecimal.valueOf(23)).difference(BigDecimal.valueOf(3)).date("132").build(),
                        CurrencyCreDto.builder().id(21).code("234").currency("EUR").nameRussian("Доллар США").nameUzbek("AQSH dollari").nameUzbekKrill("АҚШ доллари").nameEnglish("US Dollar").nominal("1").rate(BigDecimal.valueOf(34)).difference(BigDecimal.valueOf(43)).date("234").build(),
                        CurrencyCreDto.builder().id(57).code("123").currency("RUB").nameRussian("Доллар США").nameUzbek("AQSH dollari").nameUzbekKrill("АҚШ доллари").nameEnglish("US Dollar").nominal("1").rate(BigDecimal.valueOf(32)).difference(BigDecimal.valueOf(234)).date("345").build()
                );
    }
